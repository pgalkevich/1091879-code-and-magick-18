...
(function () {
  ...
  var createWizard = function () {
    var wizardItem = {};
    var firstNameIndex = window.utils.getRandomIndex(0, firstNames.length);
    var lastNameIndex = window.utils.getRandomIndex(0, lastNames.length);
    var coatColorIndex = window.utils.getRandomIndex(0, coatColors.length);
    var eyesColorIndex = window.utils.getRandomIndex(0, eyesColors.length);
